...
public class ExceptionController extends ResponseEntityExceptionHandler {
    ...
    private static final String ERRORS_FOR_PATH = "Error: {} for path: {}";

    @ExceptionHandler(CourierNotFoundException.class)
    public ResponseEntity<Object> handlerCourierNotFoundException(CourierNotFoundException ex,
                                                           WebRequest request) {
    ...
    public ResponseEntity<Object> handlerCourierAlreadyExistsException(CourierAlreadyExistsException ex,
                                                                  WebRequest request) {
    ...
    private ResponseEntity<Object> getExceptionResponseEntity(final Exception ex,
        ...
        log.error(ERRORS_FOR_PATH, ex.getMessage(), path);
